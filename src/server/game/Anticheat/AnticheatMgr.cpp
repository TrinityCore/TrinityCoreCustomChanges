...
void AnticheatMgr::SavePlayerData(Player* player)
{
    ...
    CharacterDatabase.PExecute("REPLACE INTO players_reports_status (guid,average,total_reports,speed_reports,fly_reports,jump_reports,waterwalk_reports,teleportplane_reports,climb_reports,teleport_reports,ignorecontrol_reports,zaxis_reports,antiswim_reports,gravity_reports,creation_time) VALUES (%u,%f,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u);", player->GetGUID().GetCounter(), playerData.GetAverage(), playerData.GetTotalReports(), playerData.GetTypeReports(SPEED_HACK_REPORT), playerData.GetTypeReports(FLY_HACK_REPORT), playerData.GetTypeReports(JUMP_HACK_REPORT), playerData.GetTypeReports(WALK_WATER_HACK_REPORT), playerData.GetTypeReports(TELEPORT_PLANE_HACK_REPORT), playerData.GetTypeReports(CLIMB_HACK_REPORT), playerData.GetTypeReports(TELEPORT_HACK_REPORT), playerData.GetTypeReports(IGNORE_CONTROL_REPORT), playerData.GetTypeReports(ZAXIS_HACK_REPORT), playerData.GetTypeReports(ANTISWIM_HACK_REPORT), playerData.GetTypeReports(GRAVITY_HACK_REPORT), m_Players[player->GetGUID()].GetCreationTime());
}
...
void AnticheatMgr::BuildReport(Player* player, uint8 reportType)
{
    ...
    if (sWorld->getIntConfig(CONFIG_ANTICHEAT_MAX_REPORTS_FOR_DAILY_REPORT) < m_Players[key].GetTotalReports())
    {
        if (!m_Players[key].GetDailyReportState())
        {
            ...
            CharacterDatabase.PExecute("REPLACE INTO players_reports_status (guid,average,total_reports,speed_reports,fly_reports,jump_reports,waterwalk_reports,teleportplane_reports,climb_reports,teleport_reports,ignorecontrol_reports,zaxis_reports,antiswim_reports,gravity_reports,creation_time) VALUES (%u,%f,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u);", counter, m_Players[counter].GetAverage(), m_Players[counter].GetTotalReports(), m_Players[counter].GetTypeReports(SPEED_HACK_REPORT), m_Players[counter].GetTypeReports(FLY_HACK_REPORT), m_Players[counter].GetTypeReports(JUMP_HACK_REPORT), m_Players[counter].GetTypeReports(WALK_WATER_HACK_REPORT), m_Players[counter].GetTypeReports(TELEPORT_PLANE_HACK_REPORT), m_Players[counter].GetTypeReports(CLIMB_HACK_REPORT), m_Players[counter].GetTypeReports(TELEPORT_HACK_REPORT), m_Players[counter].GetTypeReports(IGNORE_CONTROL_REPORT), m_Players[counter].GetTypeReports(ZAXIS_HACK_REPORT), m_Players[counter].GetTypeReports(ANTISWIM_HACK_REPORT), m_Players[counter].GetTypeReports(GRAVITY_HACK_REPORT), m_Players[player->GetGUID()].GetCreationTime());
